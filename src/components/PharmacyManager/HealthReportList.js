...
function HealthReportList() {
    ...
    return (
        <div>
           ...
           <Link to = "/adminPannel/PharmacyManager/add-healthrecord" className = "btn btn-primary mb-2" > 
                        ...
                        <tbody>
                            {
                               ...
                               <tr key = {healthrecord.id} className="border-b font-medium dark:border-neutral-500"> 
                                   ...
                                   <td className="whitespace-nowrap px-6 py-4 font-medium">
                                       <Link className="btn btn-info" to={`/edit-healthrecord/${healthrecord.id}`} ><button style = {{marginLeft:"10px",backgroundColor :'#54B4D3',padding:10}}>Update</button></Link>
                                       <button className = "btn btn-danger" 
                                         onClick = {() => deleteHealthRecord(healthrecord.id)}
                                         style = {{marginLeft:"10px",backgroundColor :'#DC4C64',padding:10}}> Delete</button>
